        ...
        <div className='container'>
          <div className='row'>
                ...
                <div className='card'>
                  ...
                  <div className='card-body'>
                    ...
                    <>
                      ...
                      <td>   
                      <div className='addbtn'><RemoveIcon  onClick={()=> updateItemQuantity(item.id, item.quantity - 1) } style={{height:'1.5rem', width:'2rem'}}/>
                      <h5>{item.quantity}</h5>
                      <AddIcon onClick={()=> updateItemQuantity(item.id, item.quantity + 1)} style={{height:'1.5rem', width:'2rem'}}/></div></td>
                      <td>
                      <button className='btn ms-2' onClick={() => removeItem(item.id)}><DeleteIcon/></button>
                      </td>
                      </tr>
                    </>
                    )
              ...
              <h4>Order Summery</h4>
                ...
                <td><h3>Rs. {cartTotal}</h3></td>
                </tr>
                </table>
                {/* <div className='col-auto ms-auto'><h3>Total Price: Rs {cartTotal}</h3></div>
                <div className='col-auto ms-auto'><h3>Total Items:  {totalUniqueItems}</h3></div> */}
